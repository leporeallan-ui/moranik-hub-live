...
const TestApp1: React.FC = () => {
  console.log('TestApp1 component rendering...');
  
  const [activeView] = useState('landing');
  const [cartCount] = useState(0);
  
  console.log('TestApp1 state initialized');
  ...
  console.log('About to render TestApp1 with Layout...');
  return (
    <Layout activeView={activeView} onNavigate={() => {}} cartCount={cartCount}>
      {renderLanding()}
    </Layout>
  );
};
